...
def _get_context(question: str, initial_k: int = 20, final_k: int = 3) -> str:
...
def _full_context(max_chars: int = 6000) -> str:
    if not parents:
        raise RuntimeError("문서가 업로드되지 않았습니다.")
